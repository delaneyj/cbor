...
```bash
go run github.com/delaneyj/cbor/cborgen@latest -i mytypes.go -o internal/gen/mytypes_cbor.go
```
...
```go
//go:generate go run github.com/delaneyj/cbor/cborgen@latest -i $GOFILE
```
...
- JSON v1 (`encoding/json`).
- JSON v2 (`go-json-experiment/json`).
...
CBOR (cbor/runtime)          1896      1152.43   1569       0.00           0
JSON (encoding/json)         2503      214.89    11108      28.00          3485
JSON v2 (json-experiment)    2503      177.66    13436      51.00          3314
MSGP (generated MarshalMsg)  1904      907.44    2001       0.00           0
```
...
CBOR (cbor/runtime)          1896      520.64    3473       67.00          5492
JSON (encoding/json)         2503      73.77     32359      149.00         7496
JSON v2 (json-experiment)    2503      89.40     26702      416.00         22593
MSGP (generated MarshalMsg)  1904      466.91    3889       107.00         4944
```
